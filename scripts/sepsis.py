# Script: insurance.py
# Purpose: Clean and prepare the Insurance Claims event log for process mining.
# Input: Insurance_Event_Log.csv
...
# Load the Insurance Claims event log from CSV 
...
# Remove cases with fewer than two events
