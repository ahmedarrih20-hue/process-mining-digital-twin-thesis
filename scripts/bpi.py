# Script: bpi.py
# Purpose: Clean and prepare the BPI Challenge 2012 event log for process mining.
# Input: BPI_Challenge_2012.xes
# Outputs: cleaned event log, summary tables, and basic analysis figures.
...
# Load the BPI Challenge 2012 event log.
log = pm4py.read_xes("BPI_Challenge_2012.xes")

# Convert the XES event log to a DataFrame.
df = pm4py.convert_to_dataframe(log)

print("Dataset loaded")
print("Shape:", df.shape)

# Store basic statistics before cleaning.
...
# Store basic statistics after cleaning.
...
# Save the cleaned event log.
df.to_csv("outputs/cleaned_data/bpi_cleaned.csv", index=False)

# Create and save the before/after summary table.
...
# Create and save the cleaning summary table.
...
# Plot case duration distribution.
...
# Print final summary in the console.
